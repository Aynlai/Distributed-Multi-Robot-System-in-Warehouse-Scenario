load exampleMultiAgentParams.mat
load exampleMultiAgentWarehouseMap.mat
load exampleMultiAgentPackages.mat
...
taskingAlgorithm = "auction"; %greedy,munkres,auction
...
nodeElems(1).DataType = 'boolean';
nodeElems(2) = Simulink.BusElement;
...
networkElems(1).Dimensions = size(logicalMap);
